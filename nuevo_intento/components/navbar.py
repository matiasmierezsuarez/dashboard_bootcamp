...
from nuevo_intento import styles
...
def menu_item(text: str, url: str) -> rx.Component:
    ...
    return rx.link(
        rx.hstack(
            rx.match(
                text,
                ("Dashboard", menu_item_icon("home")),
                ("Análisis Temporal", menu_item_icon("presentation")),
                ("Table", menu_item_icon("table-2")),
                ("Vendedores", menu_item_icon("shopping-bag")),
